class PedidoModel {
  num? id;
  num? produtosSeparados;
  num? produtosEmbalados;
  num? produtosConferidos;
  num? quantidadeProdutos;
  String? dataCriacao;
  num? idCriador;
  num? idCliente;
  num? idSituacao;
  ...
  PedidoModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    produtosSeparados = json['produtosSeparados'];
    produtosEmbalados = json['produtosEmbalados'];
    produtosConferidos = json['produtosConferidos'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = id;
    data['produtosSeparados'] = produtosSeparados;
    data['produtosEmbalados'] = produtosEmbalados;
    data['produtosConferidos'] = produtosConferidos;
    data['quantidadeProdutos'] = quantidadeProdutos;
